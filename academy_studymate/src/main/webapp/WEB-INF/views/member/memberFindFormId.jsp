		...
		<!-- 관리자 여부로 서브메뉴 구분필요 -->
			...
			<article class="resInfo">
				<div class="container col-xs-12">
			    	<div class="jumbotron">
					    <h3>회원정보찾기</h3>      
					    <p class='hidden-xs'>아이디 찾기</p>
					</div>
				</div>
			</article>
			<article>
				<form:form id="findIdForm" class="form-horizontal" method="POST" commandName="findDto" action="${pageContext.request.contextPath}/memberFindId">
					<div class="container col-xs-12">
						<fieldset>
							<!-- Form Name -->
