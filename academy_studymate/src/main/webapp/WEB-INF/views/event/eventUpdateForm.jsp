...
<html>
	...
	<body>
		<div class="wrapper">
				...
				<form:form id="multiform" method="POST" commandName="eventDto" enctype="multipart/form-data" action="${pageContext.request.contextPath}/eventUpdate">
					<table class="table">
						...
						<tr>
							...
							<td><form:input path="boeTitle" maxlength="25" cssClass="form-control" value="${eventDto.boeTitle}" placeholder="제목을 입력해주세요"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><form:textarea cssClass="textcontent" path="boeContent" cols="100" rows="20" value="${eventDto.boeContent}"/></td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type="number" name="boeAble" min="1" max="20"  value="${eventDto.boeAble}" />&nbsp;명
							</td>
						</tr>
						<tr>
							<td>
			...
			<input type="hidden" id="boardsubtitle" value="이벤트수정">
			<input type="hidden" id="boardinfo" value="이벤트를 수정합니다">
