...
<link rel="stylesheet" href="<c:url value='/resources/css/board.css?v=13'/>">
...
<script type="text/javascript" src="<c:url value='/resources/js/board.js?v=11'/>" charset="utf-8"></script>
