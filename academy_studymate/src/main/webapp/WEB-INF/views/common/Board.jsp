...
<link rel="stylesheet" href="<c:url value='/resources/css/board.css?v=4'/>">
...
<script type="text/javascript" src="<c:url value='/resources/js/board.js?v=18'/>" charset="utf-8"></script>
