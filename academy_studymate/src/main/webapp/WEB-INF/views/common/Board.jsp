...
<link rel="stylesheet" href="<c:url value='/resources/css/board.css?v=29'/>">
...
<script type="text/javascript" src="<c:url value='/resources/js/board.js?v=23'/>" charset="utf-8"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/jquery.form.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/jQuery.MultiFile.min.js"></script>
